                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(Color.fromRGBO(59, 59, 59, 1)),
                        ...
                        ElevatedButton(
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(Color.fromRGBO(50, 50, 50, 1)),
                              fixedSize: WidgetStateProperty.all(Size(100, 100)),
                              shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
                            ),
                            onPressed: ()=>{
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(Color.fromRGBO(244, 67, 54, 1)),
                              fixedSize: WidgetStateProperty.all(Size(100, 100)),
                              shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
                            ),
                            onPressed: ()=>{
                        ...
                        ElevatedButton(
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(Color.fromRGBO(76, 194, 255, 1)),
                              fixedSize: WidgetStateProperty.all(Size(100, 100)),
                              shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
                            ),
                            onPressed: ()=>{
